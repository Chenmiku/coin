          ...
          <div <#if international>class="tab-content bg-white" <#else>class="panel-body"</#if>>
              ...
              <#if im.koKr>
                <div id="${tabPath}-ko" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textKoKr" "/admin/category-qna/${category.id?c}/duplicate/ko_KR"/>
              ...
              <#if im.enUs>
                <div id="${tabPath}-en" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textEnUs" "/admin/category-qna/${category.id?c}/duplicate/en_US"/>
              ...
              <#if im.zhCn>
                <div id="${tabPath}-zh-cn" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textZhCn" "/admin/category-qna/${category.id?c}/duplicate/zh_CN"/>
              ...
              <#if im.zhTw>
                <div id="${tabPath}-zh-tw" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textZhTw" "/admin/category-qna/${category.id?c}/duplicate/zh_TW"/>
              ...
              <#if im.jaJp>
                <div id="${tabPath}-ja" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textJaJp" "/admin/category-qna/${category.id?c}/duplicate/ja_JP"/>
