      ...
      <div class="col-md-12">
        ...
        <div class="pull-left mb-lg">
          <button type="submit" class="btn btn-primary btn-lg">
            ...
            <@spring.formHiddenInput "category.type"/>
          ...
          <div <#if international>class="tab-content bg-white" <#else>class="panel-body"</#if>>
              ...
              <#if im.koKr>
                <div id="${tabPath}-ko" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textKoKr" "/admin/category-post/${category.id?c}/duplicate/${category.type}/ko_KR"/>
              ...
              <#if im.enUs>
                <div id="${tabPath}-en" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textEnUs" "/admin/category-post/${category.id?c}/duplicate/${category.type}/en_US"/>
              ...
              <#if im.zhCn>
                <div id="${tabPath}-zh-cn" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textZhCn" "/admin/category-post/${category.id?c}/duplicate/${category.type}/zh_CN"/>
              ...
              <#if im.zhTw>
                <div id="${tabPath}-zh-tw" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textZhTw" "/admin/category-post/${category.id?c}/duplicate/${category.type}/zh_TW"/>
              ...
              <#if im.jaJp>
                <div id="${tabPath}-ja" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textJaJp" "/admin/category-post/${category.id?c}/duplicate/${category.type}/ja_JP"/>
