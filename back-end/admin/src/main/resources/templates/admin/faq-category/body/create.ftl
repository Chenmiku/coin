          ...
          <div <#if international>class="tab-content bg-white" <#else>class="panel-body"</#if>>
              ...
              <#if im.koKr>
                <div id="${tabPath}-ko" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textKoKr" "/admin/category-faq/duplicate/ko_KR"/>
              ...
              <#if im.enUs>
                <div id="${tabPath}-en" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textEnUs" "/admin/category-faq/duplicate/en_US"/>
              ...
              <#if im.zhCn>
                <div id="${tabPath}-zh-cn" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textZhCn" "/admin/category-faq/duplicate/zh_CN"/>
              ...
              <#if im.zhTw>
                <div id="${tabPath}-zh-tw" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textZhTw" "/admin/category-faq/duplicate/zh_TW"/>
              ...
              <#if im.jaJp>
                <div id="${tabPath}-ja" <#if international>role="tabpanel" class="tab-pane"</#if>>
                    <@ui.formCategoryByInputName "category.name.textJaJp" "/admin/category-faq/duplicate/ja_JP"/>
      ...
      <div class="col-lg-5 pl0-lg">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
              ...
              <#-- 아이콘 이미지 -->
              <@ui.uploadImage "아이콘 이미지" "image" "" "44px 이상 정사각형 png 이미지로만 업로드해주세요."/>
              <#-- END : 아이콘 이미지 -->
