...
public class AdminPostContentsController {

  private static final Post.Type TYPE = Post.Type.CONTENTS;
  ...
  public ModelAndView page(Model model,
    ...
    return new ModelAndView("admin/post-contents/list.ftl");
  }
  ...
  public ModelAndView create(Model model,
    ...
    return new ModelAndView("admin/post-contents/create.ftl");
  }

  @GetMapping("update/{idPost}")
  public ModelAndView update(@PathVariable Long idPost,
                             @ModelAttribute("setting") AppSetting setting,
                             Model model) {

    Post post = postService.get(setting.getDefaultLocale(), idPost);
    ...
    return new ModelAndView("/admin/post-contents/update.ftl");
  }
  ...
  public ModelAndView postCreate(@Valid Post post,
    ...
    status.setComplete();
    return new ModelAndView("redirect:/admin/contents");
  }
  ...
  public ModelAndView postUpdate(@Valid Post post,
    ...
    status.setComplete();
    return new ModelAndView("redirect:/admin/contents/update/" + post.getId() + "?success");
  }
