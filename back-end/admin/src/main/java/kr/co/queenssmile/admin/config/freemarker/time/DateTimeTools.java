...
public final class DateTimeTools {
     ...
     */
    public static DateTimeFormatter createDateTimeFormatter(java.util.List list,
                                                            int index,
     ...
     */
    public static ZoneId zoneIdLookup(java.util.List list, int index) throws TemplateModelException {
