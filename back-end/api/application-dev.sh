...
# 쉬고 있는 set 찾기: api-dev1이 사용중이면 api-dev2가 쉬고 있고, 반대면 api-dev1이 쉬고 있음
if [ $CURRENT_PROFILE == api-dev1 ]
then
  IDLE_PROFILE=api-dev2
  IDLE_PROFILE_KILL=api-dev1
  IDLE_PORT=18086
elif [ $CURRENT_PROFILE == api-dev2 ]
then
  IDLE_PROFILE=api-dev1
  IDLE_PROFILE_KILL=api-dev2
  IDLE_PORT=18087
else
  echo "> 일치하는 Profile이 없습니다. Profile: $CURRENT_PROFILE"
  echo "> api-dev1을 할당합니다. IDLE_PROFILE: api-dev1"
  IDLE_PROFILE=api-dev1
  IDLE_PROFILE_KILL=api-dev2
  IDLE_PORT=18087
fi
